...
For the polyglot-curious: I've attended a number of gatherings which I must tout: the [Polyglot Conference](https://polyglotconference.com/), the [Language Event](https://languageevent.com/), and the [Polyglot Gathering](https://www.polyglotgathering.com).

Related to my infatuation with foreign language is my collection of translations of various books, mostly *Le Petit Prince*. Here is my [Little Prince Collection](https://lepetitprince.international).
